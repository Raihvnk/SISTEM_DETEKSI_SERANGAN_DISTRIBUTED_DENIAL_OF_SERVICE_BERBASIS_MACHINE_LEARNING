...
# %%
#Random Forest dengan metode Random Subsampling
...
# Menghitung dan mencetak akurasi model dengan metode Random Subsampling
modelScore = model.score(X_test, y_test)
print("Random Subsampling score: ", modelScore)


# %%
#Random Forest dengan K-Fold Cross Validation:
...
modelScore = cross_val_score(rf_model, X, y, cv=kFoldValidation)
...
maeScore = cross_val_score(rf_model, X, y, cv=kFoldValidation, scoring='neg_mean_absolute_error')
...
rmseScore = cross_val_score(rf_model, X, y, cv=kFoldValidation, scoring='neg_mean_squared_error')
